#!/usr/bin/env python3
"""
Working ADK Agent Tests - Testing Actual Google ADK Agents with Gemini API
These tests use the real agents with the correct ADK API
"""
...
def test_working_adk_agent():
    """Test creating a working ADK agent and making API calls"""
    print("🔍 TESTING WORKING ADK AGENT WITH GEMINI API")
    print("=" * 60)
    ...
    try:
        ...
        print("[DEBUG] Creating working ADK agent...")
        ...
        # Test with runner (pass agent to constructor)
        ...
        print(f"[DEBUG] ❌ Working ADK agent test failed: {e}")
        import traceback
        traceback.print_exc()
        return False, 0

def test_multiple_working_agents():
    """Test creating multiple working ADK agents"""
    print("\n🔍 TESTING MULTIPLE WORKING ADK AGENTS")
    print("=" * 60)
    ...
    try:
        ...
        print(f"[DEBUG] ❌ Multiple working agents test failed: {e}")
        import traceback
        traceback.print_exc()
        return False, 0
...
def main():
    """Main test function"""
    print("🚀 WORKING ADK AGENT TESTS - USING ACTUAL AGENTS WITH GEMINI API")
    print("=" * 80)
    ...
    # Run all tests
    tests = [
        ("Working ADK Agent", test_working_adk_agent),
        ("Multiple Working ADK Agents", test_multiple_working_agents),
    ...
    # Summary
    print("\n📊 WORKING ADK AGENT TEST RESULTS")
    print("=" * 80)
    ...
    if passed == total:
        print(f"\n🎉 ALL WORKING ADK AGENT TESTS PASSED!")
